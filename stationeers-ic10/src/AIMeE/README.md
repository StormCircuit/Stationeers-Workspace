...
4. Set the device pins
5. Set robotXmitter to the housings respective aimee transmitter
6. Set recallLever to anything with a Setting that On = 1
7. Make sure recallLever Setting = 1 to prevent runaway AIMeE's
...
**SP 509** is MinimumOreError. If Aimee sees LESS ore than this, she will error and stay at home
**SP 508** is MineablesInVicinity. aimee sees whenever she performs her recall check
**SP 507** is TimeoutError. Aimee will drive in circles doing nothing for this many seconds before she gives up and checks how if MineablesInVicinity <= MinimumOreError. Successfully mining resets the counter.
...
**SP 505** is last visited waypoint SP.